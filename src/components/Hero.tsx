...
export default function Hero() {
  return (
    <section className='flex flex-col lg:flex-row items-center justify-center min-h-screen bg-gradient-to-b from-[#FFD6CC] via-[#FFEDEA] to-[#FFFFFF] pb-10' id='Home'>
        <div className='flex flex-col items-center justify-center text-center lg:text-left gap-4 lg:gap-5 p-4 order-2 lg:order-1 '>
          ...
          <motion.p
            animate={{ scale: 2 }}
            className="font-semibold text-xl md:text-2xl text-gray-400 text-shadow-md text-shadow-gray-300">
            Frontend Developer
          </motion.p>
